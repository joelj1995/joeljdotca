...
$Cmd = "ansible-playbook -i ${CICDPath}/Ansible-Inventory-WORLD1.yml $RepoRootPath/cicd/Ansible-Playbook-Deploy-Gateway.yml --extra-vars `"root_password=$RootPassword slot=blue`""
