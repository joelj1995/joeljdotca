...
sed -i "s/{{WP_SITE_URL}}/$WP_DB_PASSWORD/" ./wordpress/wp-config.php
sed -i "s/{{WP_DB_USER}}/$WP_DB_PASSWORD/" ./wordpress/wp-config.php
sed -i "s/{{WP_DB_NAME}}/$WP_DB_PASSWORD/" ./wordpress/wp-config.php
